        ...
        <div className='max-w-6xl mx-auto'>
            ...
            <div className=''>
                ...
                <h2 className='text-3xl md:w-4/5 w-full md:text-4xl font-bold text-gray-900'>
                    Purpose of a convy is to keep your team
                </h2>
            </div>
            ...
            <div className='col-span-2 grid grid-cols-1 md:grid-cols-2 justify-between gap -8'>
                {
                    features.map((feature, index) => (
                        <div key={index} className='flex spacr-x-4'>
                            <div className='w-12 h-12 flex item-center justify-start rounded-lg'>{feature.icon}</div>
